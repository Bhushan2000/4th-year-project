 ...
 * @author Giridhar
 */
public class SignupAdminFrame extends javax.swing.JInternalFrame {

    /**
     * Creates new form SignupFrame
     */
    public SignupAdminFrame() {
        initComponents();
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        try
        {
            ...
            if(name.isEmpty())
            {
                JOptionPane.showMessageDialog(this, "Name cannot be Empty!", "Sign up", JOptionPane.INFORMATION_MESSAGE);

            }
            if(email.isEmpty())
            {
                   JOptionPane.showMessageDialog(this, "Email cannot be Empty!", "Sign up", JOptionPane.INFORMATION_MESSAGE);
            }
            if(phone.isEmpty())
            {
                    JOptionPane.showMessageDialog(this, "Phone cannot be Empty!", "Sign up", JOptionPane.INFORMATION_MESSAGE);
