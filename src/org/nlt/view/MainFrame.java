...
public class MainFrame extends javax.swing.JFrame {
    ...
    public MainFrame() {
        ...
        Config.signupAdminFrame=new SignupAdminFrame();
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/nlt/images/LOGO5.jpg"))); // NOI18N
        jLabel3.setText("jLabel3");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1240, 560));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(204, 0, 102));
        jLabel5.setText("Are You Admin ? Yes Click Here For Sign Up");
        ...
        desktopPaneMaster.setLayer(jPanel1, javax.swing.JLayeredPane.DEFAULT_LAYER);
        desktopPaneMaster.setLayer(kGradientPanel1, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        desktopPaneMasterLayout.setVerticalGroup(
            desktopPaneMasterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(desktopPaneMasterLayout.createSequentialGroup()
...
public void setSignupAdminFrame()
{
    try
    {
        desktopPaneMaster.removeAll();
        desktopPaneMaster.add(Config.signupAdminFrame);
        Config.signupAdminFrame.setVisible(true);
        Config.signupAdminFrame.setPreferredSize(getMinimumSize());
        Config.signupAdminFrame.setClosable(true);
        Config.signupAdminFrame.setMaximum(true);
